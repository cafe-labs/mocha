  ...
  function g(o) {
    ...
    a.nativeMethods.defineProperty(o, '__uv', { value: e, enumerable: !1 }),
      ...
      (e.location = a.location.emulate(
        (t) => (t === 'about:srcdoc' ? new URL(t) : (t.startsWith('blob:') && (t = t.slice(5)), new URL(e.sourceUrl(t)))),
        (t) => e.rewriteUrl(t)
      ))
    let n = k
    if (
      ...
      o.EventTarget && ((e.addEventListener = o.EventTarget.prototype.addEventListener), (e.removeListener = o.EventTarget.prototype.removeListener), (e.dispatchEvent = o.EventTarget.prototype.dispatchEvent)),
    ...
    a.nativeMethods.defineProperty(e.meta, 'base', {
      get() {
        return o.document ? (a.node.baseURI.get.call(o.document) !== c && ((c = a.node.baseURI.get.call(o.document)), (S = e.sourceUrl(c))), S) : e.meta.url.href
      }
    }),
      (e.methods = { setSource: i + 'setSource', source: i + 'source', location: i + 'location', function: i + 'function', string: i + 'string', eval: i + 'eval', parent: i + 'parent', top: i + 'top' }),
      (e.filterKeys = [p, e.methods.setSource, e.methods.source, e.methods.location, e.methods.function, e.methods.string, e.methods.eval, e.methods.parent, e.methods.top, i + 'protocol', i + 'storageObj', i + 'url', i + 'modifiedStyle', i + 'config', i + 'dispatched', 'Ultraviolet', '__uvHook']),
      a.on('wrap', (t, r) => {
        a.nativeMethods.defineProperty(r, 'name', a.nativeMethods.getOwnPropertyDescriptor(t, 'name')),
          ...
          a.nativeMethods.defineProperty(r, e.methods.string, { enumerable: !1, value: a.nativeMethods.fnToString.call(t) }),
          a.nativeMethods.defineProperty(r, e.methods.function, { enumerable: !1, value: t })
      }),
      ...
      a.workers.on('postMessage', (t) => {
        let r = t.data.origin
        ;(t.data.origin = '*'), (t.data.message = { __data: t.data.message, __origin: e.meta.url.origin, __to: r })
      }),
      ...
      a.document.on('setCookie', (t) => {
        ...
        r.path || (r.path = '/'), r.domain || (r.domain = e.meta.url.hostname), e.cookie.validateCookie(r, e.meta, !0) && (n.length && (n += '; '), (n += `${r.name}=${r.value}`)), t.respondWith(t.data.value)
      }),
      ...
      a.element.on('setOuterHTML', (t) => {
        t.data.value = e.rewriteHtml(t.data.value, { document: t.that.tagName === 'HTML' })
      }),
      a.element.on('getOuterHTML', (t) => {
        switch (t.that.tagName) {
          ...
          case 'BODY':
            ...
            break
          default:
            t.data.value = e.sourceHtml(t.data.value, { document: t.that.tagName === 'HTML' })
            break
        }
      }),
      ...
      a.message.on('postMessage', (t) => {
        ...
        t.that && (l = t.that.__uv$source.call),
          (t.data.origin = '*'),
          (t.data.message = { __data: t.data.message, __origin: (t.that || t.target).__uv$source.location.origin, __to: r }),
          t.respondWith(f ? l(t.target, [t.data.message, t.data.transfer], t.that) : l(t.target, [t.data.message, t.data.origin, t.data.transfer], t.that))
      }),
      a.message.on('data', (t) => {
        let { value: r } = t.data
      ...
      a.element.on('setAttribute', (t) => {
        if (t.that instanceof d && t.data.name === 'src' && t.data.value.startsWith('blob:')) {
          t.target.call(t.that, e.attributePrefix + '-attr-' + t.data.name, t.data.value), (t.data.value = e.blobUrls.get(t.data.value))
          return
        }
        e.attrs.isUrl(t.data.name) && (t.target.call(t.that, e.attributePrefix + '-attr-' + t.data.name, t.data.value), (t.data.value = e.rewriteUrl(t.data.value))),
          e.attrs.isStyle(t.data.name) && (t.target.call(t.that, e.attributePrefix + '-attr-' + t.data.name, t.data.value), (t.data.value = e.rewriteCSS(t.data.value, { context: 'declarationList' }))),
          e.attrs.isHtml(t.data.name) &&
            (t.target.call(t.that, e.attributePrefix + '-attr-' + t.data.name, t.data.value), (t.data.value = e.rewriteHtml(t.data.value, { ...e.meta, document: !0, injectHead: e.createHtmlInject(e.handlerScript, e.bundleScript, e.clientScript, e.configScript, n, o.location.href) }))),
      ...
      a.element.hookProperty([_, U, v, d, y, M, j, u, H, E], 'src', {
        get: (t, r) => e.sourceUrl(t.call(r)),
        set: (t, r, [l]) => {
          if (new String(l).toString().trim().startsWith('blob:') && r instanceof d) return a.element.setAttribute.call(r, e.attributePrefix + '-attr-src', l), t.call(r, e.blobUrls.get(l) || l)
    ...
    let C = u && Object.getOwnPropertyDescriptor(u.prototype, 'contentWindow').get
    function P(t) {
      let r = C.call(t)
      if (!r.__uv)
        try {
    ...
    if (
      (a.element.hookProperty(u, 'contentWindow', { get: (t, r) => (P(r), t.call(r)) }),
      a.element.hookProperty(u, 'contentDocument', { get: (t, r) => (P(r), t.call(r)) }),
      a.element.hookProperty(u, 'srcdoc', {
        get: (t, r) => a.element.getAttribute.call(r, e.attributePrefix + '-attr-srcdoc') || t.call(r),
        set: (t, r, [l]) => {
          t.call(r, e.rewriteHtml(l, { document: !0, injectHead: e.createHtmlInject(e.handlerScript, e.bundleScript, e.clientScript, e.configScript, n, o.location.href) }))
        }
      }),
      ...
      a.document.on('parseFromString', (t) => {
        ...
        t.data.string = e.rewriteHtml(t.data.string, { ...e.meta, document: !0 })
      }),
      ...
      a.attribute.on('setValue', (t) => {
        e.attrs.isUrl(t.data.name) && (a.element.setAttribute.call(t.that.ownerElement, e.attributePrefix + '-attr-' + t.data.name, t.data.value), (t.data.value = e.rewriteUrl(t.data.value))),
          e.attrs.isStyle(t.data.name) && (a.element.setAttribute.call(t.that.ownerElement, e.attributePrefix + '-attr-' + t.data.name, t.data.value), (t.data.value = e.rewriteCSS(t.data.value, { context: 'declarationList' }))),
          e.attrs.isHtml(t.data.name) &&
            (a.element.setAttribute.call(t.that.ownerElement, e.attributePrefix + '-attr-' + t.data.name, t.data.value),
            (t.data.value = e.rewriteHtml(t.data.value, { ...e.meta, document: !0, injectHead: e.createHtmlInject(e.handlerScript, e.bundleScript, e.clientScript, e.configScript, n, o.location.href) }))),
      ...
      a.url.on('createObjectURL', (t) => {
        ...
        if (r.startsWith('blob:' + location.origin)) {
          let l = 'blob:' + (e.meta.url.href !== 'about:blank' ? e.meta.url.origin : o.parent.__uv.meta.url.origin) + r.slice(5 + location.origin.length)
      ...
      a.storage.on('set', (t) => {
        t.that.__uv$storageObj && (t.that.__uv$storageObj[t.data.name] = t.data.value), (t.data.name = i + e.meta.url.origin + '@' + t.data.name)
      }),
      a.storage.on('delete', (t) => {
        t.that.__uv$storageObj && delete t.that.__uv$storageObj[t.data.name], (t.data.name = i + e.meta.url.origin + '@' + t.data.name)
      }),
      ...
      a.storage.on('clear', (t) => {
        if (t.that.__uv$storageObj) for (let r of a.nativeMethods.keys.call(null, t.that.__uv$storageObj)) delete t.that.__uv$storageObj[r], a.storage.removeItem.call(t.that, i + e.meta.url.origin + '@' + r), t.respondWith()
      }),
      a.storage.on('length', (t) => {
        t.that.__uv$storageObj && t.respondWith(a.nativeMethods.keys.call(null, t.that.__uv$storageObj).length)
      }),
      a.storage.on('key', (t) => {
        t.that.__uv$storageObj && t.respondWith(a.nativeMethods.keys.call(null, t.that.__uv$storageObj)[t.data.index] || null)
      }),
      a.websocket.on('websocket', async (t) => {
        let r = Object.create(null)
        ;(r.Origin = e.meta.url.origin), (r['User-Agent'] = navigator.userAgent), n !== '' && (r.Cookie = n.toString()), t.respondWith(b.createWebSocket(t.data.args[0], t.data.args[1], t.target, r))
      }),
      a.websocket.on('readyState', (t) => {
        '__uv$getReadyState' in t.that && (t.data.value = t.that.__uv$getReadyState())
      }),
      ...
      a.websocket.on('url', (t) => {
        '__uv$socketUrl' in t.that && (t.data.value = t.that.__uv$socketUrl.toString())
      }),
      a.websocket.on('protocol', (t) => {
        '__uv$getProtocol' in t.that && (t.data.value = t.that.__uv$getProtocol())
      }),
      ...
      a.style.on('setProperty', (t) => {
        a.style.dashedUrlProps.includes(t.data.property) && (t.data.value = e.rewriteCSS(t.data.value, { context: 'value', ...e.meta }))
      }),
      a.style.on('getPropertyValue', (t) => {
        a.style.dashedUrlProps.includes(t.data.property) && t.respondWith(e.sourceCSS(t.target.call(t.that, t.data.property), { context: 'value', ...e.meta }))
      }),
      'CSS2Properties' in o)
    )
            ...
            if (!l[i + 'modifiedStyle'])
              for (let s of a.style.urlProps)
                a.nativeMethods.defineProperty(l, s, {
                  ...
                  set(m) {
                    a.style.setProperty.call(this, a.style.propToDashed[s] || s, e.rewriteCSS(m, { context: 'value', ...e.meta }))
                  }
                }),
                  a.nativeMethods.defineProperty(l, i + 'modifiedStyle', { enumerable: !1, value: !0 })
            return l
          }
        })
    a.style.on('setCssText', (t) => {
      ...
      e.addEventListener.call(o, 'hashchange', (t) => {
        ...
        a.history.replaceState.call(o.history, '', '', t.oldURL), (e.location.hash = r)
      }),
      a.location.on('hashchange', (t, r, l) => {
        if (l.HashChangeEvent && a.history.replaceState) {
          ...
          a.nativeMethods.defineProperty(s, i + 'dispatched', { value: !0, enumerable: !1 }), e.dispatchEvent.call(o, s)
        }
      }),
      ...
      a.overrideDescriptor(o, 'localStorage', { get: (t, r) => (r || o).__uv.lsWrap }),
      a.overrideDescriptor(o, 'sessionStorage', { get: (t, r) => (r || o).__uv.ssWrap }),
      ...
      a.nativeMethods.defineProperty(o.Object.prototype, p, { get: () => e, enumerable: !1 }),
      a.nativeMethods.defineProperty(o.Object.prototype, e.methods.setSource, {
        value: function (t) {
          return a.nativeMethods.isExtensible(this) ? (a.nativeMethods.defineProperty(this, e.methods.source, { value: t, writable: !0, enumerable: !1 }), this) : this
        },
        enumerable: !1
      }),
      a.nativeMethods.defineProperty(o.Object.prototype, e.methods.source, { value: e, writable: !0, enumerable: !1 }),
