...
;(() => {
  ...
  var We = (a, e) => () => (e || a((e = { exports: {} }).exports, e), e.exports)
  var _e = (a, e, r, t) => {
    if ((e && typeof e == 'object') || typeof e == 'function') for (let n of Ue(e)) !qe.call(a, n) && n !== r && q(a, n, { get: () => e[n], enumerable: !(t = Te(e, n)) || t.enumerable })
    return a
  }
  var p = (a, e, r) => ((r = a != null ? Ae(je(a)) : {}), _e(e || !a || !a.__esModule ? q(r, 'default', { value: a, enumerable: !0 }) : r, a))
  var c = We((Je, P) => {
    'use strict'
    ...
    l.prototype.setMaxListeners = function (e) {
      if (typeof e != 'number' || e < 0 || F(e)) throw new RangeError('The value of "n" is out of range. It must be a non-negative number. Received ' + e + '.')
    ...
    l.prototype.emit = function (e) {
      ...
      else for (var d = u.length, v = z(u, d), t = 0; t < d; ++t) W(v[t], this, r)
      return !0
    }
    function B(a, e, r, t) {
      var n, i, o
      if ((w(r), (i = a._events), i === void 0 ? ((i = a._events = Object.create(null)), (a._eventsCount = 0)) : (i.newListener !== void 0 && (a.emit('newListener', e, r.listener ? r.listener : r), (i = a._events)), (o = i[e])), o === void 0)) (o = i[e] = r), ++a._eventsCount
      else if ((typeof o == 'function' ? (o = i[e] = t ? [r, o] : [o, r]) : t ? o.unshift(r) : o.push(r), (n = G(a)), n > 0 && o.length > n && !o.warned)) {
        o.warned = !0
        ...
        ;(h.name = 'MaxListenersExceededWarning'), (h.emitter = a), (h.type = e), (h.count = o.length), Fe(h)
      }
      return a
    }
    ...
    l.prototype.removeListener = function (e, r) {
      ...
      if (t === r || t.listener === r) --this._eventsCount === 0 ? (this._events = Object.create(null)) : (delete n[e], n.removeListener && this.emit('removeListener', e, t.listener || r))
        ...
        if (i < 0) return this
        i === 0 ? t.shift() : Be(t, i), t.length === 1 && (n[e] = t[0]), n.removeListener !== void 0 && this.emit('removeListener', e, h || r)
      }
      return this
    }
    ...
    function X(a, e, r) {
      ...
      if (t === void 0) return []
      var n = t[e]
      return n === void 0 ? [] : typeof n == 'function' ? (r ? [n.listener || n] : [n]) : r ? Ke(n) : z(n, n.length)
    }
    ...
    l.listenerCount = function (a, e) {
      return typeof a.listenerCount == 'function' ? a.listenerCount(e) : Q.call(a, e)
    }
    ...
    function Xe(a, e) {
      return new Promise(function (r, t) {
        ...
        function i() {
          typeof a.removeListener == 'function' && a.removeListener('error', n), r([].slice.call(arguments))
        }
  ...
  var x = class extends Y.default {
      ...
      overrideDomain() {
        this.ctx.overrideDescriptor(this.docProto, 'domain', {
          ...
          set: (e, r, [t]) => {
            ...
            return this.emit('setDomain', n), n.intercepted ? n.returnValue : n.target.call(n.that, n.data.value)
          }
        })
      }
      overrideReferrer() {
      ...
      overrideCreateTreeWalker() {
        this.ctx.override(this.docProto, 'createTreeWalker', (e, r, t) => {
          ...
          let [n, i = 4294967295, o, h] = t,
            u = new s({ root: n, show: i, filter: o, expandEntityReferences: h }, e, r)
          return this.emit('createTreeWalker', u), u.intercepted ? u.returnValue : u.target.call(u.that, u.data.root, u.data.show, u.data.filter, u.data.expandEntityReferences)
        })
      }
      overrideWrite() {
      ...
      overrideCookie() {
        this.ctx.overrideDescriptor(this.docProto, 'cookie', {
          ...
          set: (e, r, [t]) => {
            let n = new s({ value: t }, e, r)
            return this.emit('setCookie', n), n.intercepted ? n.returnValue : n.target.call(n.that, n.data.value)
          }
        })
      }
      overrideTitle() {
        this.ctx.overrideDescriptor(this.docProto, 'title', {
          ...
          set: (e, r, [t]) => {
            let n = new s({ value: t }, e, r)
            return this.emit('setTitle', n), n.intercepted ? n.returnValue : n.target.call(n.that, n.data.value)
          }
        })
      }
    },
  ...
  var b = class extends $.default {
      ...
      overrideHtml() {
        this.hookProperty(this.Element, 'innerHTML', {
          ...
          set: (e, r, [t]) => {
            let n = new s({ value: t }, e, r)
            if ((this.emit('setInnerHTML', n), n.intercepted)) return n.returnValue
          ...
          this.hookProperty(this.Element, 'outerHTML', {
            ...
            set: (e, r, [t]) => {
              let n = new s({ value: t }, e, r)
              if ((this.emit('setOuterHTML', n), n.intercepted)) return n.returnValue
              e.call(r, n.data.value)
            }
          })
      }
  ...
  var O = class extends te.default {
      ...
      overrideTextContent() {
        this.ctx.overrideDescriptor(this.nodeProto, 'textContent', {
          ...
          set: (e, r, [t]) => {
            let n = new s({ value: t }, e, r)
            if ((this.emit('setTextContent', n), n.intercepted)) return n.returnValue
            e.call(r, n.data.value)
          }
        })
      }
      overrideAppend() {
        this.ctx.override(this.nodeProto, 'append', (e, r, [...t]) => {
          ...
          return this.emit('append', n), n.intercepted ? n.returnValue : n.target.call(n.that, n.data.nodes)
        }),
        ...
        return this.Headers
          ? (this.ctx.overrideDescriptor(this.reqProto, 'headers', {
            ...
            this.ctx.override(this.headersProto, 'get', (e, r, [t]) => {
              ...
              return this.emit('getHeader', n), n.intercepted ? n.returnValue : n.data.value
            }),
  ...
  var M = class extends de.default {
      ...
      overrideOpen() {
        this.ctx.override(this.xhrProto, 'open', (e, r, t) => {
          ...
          let [n, i, o = !0, h = null, u = null] = t,
            d = new s({ method: n, input: i, async: o, user: h, password: u }, e, r)
          return this.emit('open', d), d.intercepted ? d.returnValue : d.target.call(d.that, d.data.method, d.data.input, d.data.async, d.data.user, d.data.password)
        })
      }
      overrideResponseUrl() {
      ...
      overrideSend() {
        this.ctx.override(this.xhrProto, 'send', (e, r, [t = null]) => {
          ...
          return this.emit('send', n), n.intercepted ? n.returnValue : n.target.call(n.that, n.data.body)
        })
      }
  ...
  var k = class extends pe.default {
      ...
      overrideConstruct() {
        this.ctx.override(
          ...
          'EventSource' in this.window && ((this.window.EventSource.CONNECTING = this.CONNECTING), (this.window.EventSource.OPEN = this.OPEN), (this.window.EventSource.CLOSED = this.CLOSED))
      }
      overrideUrl() {
  ...
  var V = class extends me.default {
      ...
      overridePushState() {
        this.ctx.override(this.historyProto, 'pushState', (e, r, t) => {
          ...
          return this.emit('pushState', h), h.intercepted ? h.returnValue : h.target.call(h.that, h.data.state, h.data.title, h.data.url)
        })
      }
      overrideReplaceState() {
        this.ctx.override(this.historyProto, 'replaceState', (e, r, t) => {
          ...
          let [n, i, o = ''] = t,
            h = new s({ state: n, title: i, url: o }, e, r)
          return this.emit('replaceState', h), h.intercepted ? h.returnValue : h.target.call(h.that, h.data.state, h.data.title, h.data.url)
        })
      }
      overrideGo() {
        this.ctx.override(this.historyProto, 'go', (e, r, [t]) => {
          let n = new s({ delta: t }, e, r)
          return this.emit('go', n), n.intercepted ? n.returnValue : n.target.call(n.that, n.data.delta)
        })
      }
      overrideForward() {
  ...
  var we = p(c(), 1),
    N = class extends we.default {
      ...
      overrideWorkerLocation(e) {
        ...
        let r = this
        for (let t of this.keys) this.ctx.overrideDescriptor(this.workerLocProto, t, { get: () => e(r.href.get.call(this.location))[t] })
        return !0
      }
      emulate(e, r) {
        let t = {},
                ...
                ? function (o) {
                    switch (i) {
                      case 'href':
                        ...
                        break
                      case 'hash':
                        n.emit('hashchange', t.href, o.trim().startsWith('#') ? new URL(o.trim(), t.href).href : new URL('#' + o.trim(), t.href).href, n)
                        break
                      default:
                        {
        ...
        return (
          'reload' in this.location && this.ctx.nativeMethods.defineProperty(t, 'reload', { value: this.ctx.wrap(this.location, 'reload', (i, o) => i.call(o === t ? this.location : o)), writable: !1, enumerable: !0 }),
          ...
          'ancestorOrigins' in this.location &&
            this.ctx.nativeMethods.defineProperty(t, 'ancestorOrigins', {
              get() {
                let i = []
                return n.window.DOMStringList && n.ctx.nativeMethods.setPrototypeOf(i, n.window.DOMStringList.prototype), i
              },
              set: void 0,
              enumerable: !0
            }),
          this.ctx.nativeMethods.defineProperty(t, 'toString', { value: this.ctx.wrap(this.location, 'toString', () => t.href), enumerable: !0, writable: !1 }),
          this.ctx.nativeMethods.defineProperty(t, Symbol.toPrimitive, { value: () => t.href, writable: !1, enumerable: !1 }),
  ...
  var R = class extends Pe.default {
      ...
      overridePostMessage() {
        this.ctx.override(this.window, 'postMessage', (e, r, t) => {
          ...
          let h = new s({ message: n, origin: i, transfer: o, worker: this.ctx.worker }, e, r)
          return this.emit('postMessage', h), h.intercepted ? h.returnValue : this.ctx.worker ? h.target.call(h.that, h.data.message, h.data.transfer) : h.target.call(h.that, h.data.message, h.data.origin, h.data.transfer)
        })
      }
      wrapPostMessage(e, r, t = !1) {
        return this.ctx.wrap(e, r, (n, i, o) => {
          ...
          let v = new s({ message: h, origin: u, transfer: d, worker: this.ctx.worker }, n, e)
          return this.emit('postMessage', v), v.intercepted ? v.returnValue : t ? v.target.call(v.that, v.data.message, v.data.transfer) : v.target.call(v.that, v.data.message, v.data.origin, v.data.transfer)
        })
      }
  ...
  var H = class extends Oe.default {
      ...
      overrideImportScripts() {
        this.ctx.override(this.window, 'importScripts', (e, r, t) => {
          ...
          return this.emit('importScripts', n), n.intercepted ? n.returnValue : n.target.apply(n.that, n.data.scripts)
        })
      }
    },
    Se = H
  ...
  var A = class extends De.default {
      ...
      overrideLength() {
        this.ctx.overrideDescriptor(this.storeProto, 'length', {
          get: (e, r) => {
            let t = new s({ length: e.call(this.wrappers.get(r) || r) }, e, this.wrappers.get(r) || r)
      ...
      emulate(e, r = {}) {
        ...
        let t = new this.ctx.window.Proxy(r, {
          get: (n, i) => {
            ...
            return this.emit('get', o), o.intercepted ? o.returnValue : e[o.data.name]
          },
          set: (n, i, o) => {
            if (i in this.storeProto || typeof i == 'symbol') return (e[i] = o)
            let h = new s({ name: i, value: o }, null, e)
            return this.emit('set', h), h.intercepted ? h.returnValue : (e[h.data.name] = h.data.value)
          },
          deleteProperty: (n, i) => {
            if (typeof i == 'symbol') return delete e[i]
            let o = new s({ name: i }, null, e)
            return this.emit('delete', o), o.intercepted ? o.returnValue : delete e[o.data.name]
          }
        })
  ...
  var T = class extends ke.default {
      constructor(e) {
        super(),
          ...
          (this.propToDashed = { background: 'background', backgroundImage: 'background-image', borderImage: 'border-image', borderImageSource: 'border-image-source', listStyle: 'list-style', listStyleImage: 'list-style-image', cursor: 'cursor' })
      }
      ...
      overrideCssText() {
        this.ctx.overrideDescriptor(this.cssStyleProto, 'cssText', {
          ...
          set: (e, r, [t]) => {
            let n = new s({ value: t }, e, r)
            return this.emit('setCssText', n), n.intercepted ? n.returnValue : n.target.call(n.that, n.data.value)
          }
        })
      }
    },
  ...
  var U = class extends Ne.default {
      ...
      overrideOpen() {
        this.ctx.override(this.IDBFactory.prototype, 'open', (e, r, t) => {
          ...
          return this.emit('idbFactoryOpen', o), o.intercepted ? o.returnValue : o.target.call(o.that, o.data.name, o.data.version)
        })
      }
      overrideName() {
  ...
  var j = class extends Ie.default {
      ...
      overrideWebSocket() {
        this.ctx.override(
          ...
          (e, r, t) => {
            ...
            return this.emit('websocket', n), n.intercepted ? n.returnValue : new n.target(n.data.url, n.data.protocols)
          },
          !0
        ),
      ...
      overrideSend() {
        this.ctx.override(this.wsProto, 'send', (e, r, t) => {
          let n = new s({ args: t }, e, r)
          return this.emit('send', n), n.intercepted ? n.returnValue : n.target.call(n.that, n.data.args)
        })
      }
    },
    He = j
  var y = class extends Ce.default {
      ...
      wrap(e, r, t, n = !1) {
        ...
        return n && ((o.prototype = i.prototype), (o.prototype.constructor = o)), this.emit('wrap', i, o, n), o
      }
      wrapDescriptor(e, r, t = {}) {
        let n = this.nativeMethods.getOwnPropertyDescriptor(e, r)
        if (!n) return !1
        for (let i in t) i in n && (i === 'get' || i === 'set' ? (n[i] = this.wrap(n, i, t[i])) : (n[i] = typeof t[i] == 'function' ? t[i](n[i]) : t[i]))
        return n
      }
    },
    er = y
